                ...
                <Grid overflow="hidden">
                    <Column size={ 6 } overflow="hidden">
                        <Flex justifyContent="between" alignItems="center">
                            <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ LocalizeText('inventory.trading.you') } { LocalizeText('inventory.trading.areoffering') }:</Text>
                    ...
                    <Column size={ 6 } overflow="hidden">
                        <Flex justifyContent="between" alignItems="center">
                            <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ otherUser.userName } { LocalizeText('inventory.trading.isoffering') }:</Text>
