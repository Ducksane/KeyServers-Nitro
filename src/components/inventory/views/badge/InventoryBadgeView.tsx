        ...
        <Grid>
            ...
            <Column className="justify-content-between" size={ 5 } overflow="auto">
                <Column overflow="hidden" gap={ 2 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ LocalizeText('inventory.badges.activebadges') }</Text>
                ...
                { !!selectedBadgeCode &&
                    <Column grow justifyContent="end" gap={ 2 }>
                        <Flex alignItems="center" gap={ 2 }>
                            ...
                            <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ LocalizeBadgeName(selectedBadgeCode) }</Text>
                        </Flex>
