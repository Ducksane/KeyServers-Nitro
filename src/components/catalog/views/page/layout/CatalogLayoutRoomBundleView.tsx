            ...
            <Grid>
                <Column size={ 7 } overflow="hidden">
                    { !!page.localization.getText(2) &&
                        <Text style={{color: "var(--test-galaxytext)"}} variant="none" dangerouslySetInnerHTML={ { __html: page.localization.getText(2) } } /> }
                ...
                <Column size={ 5 } overflow="hidden" gap={ 1 }>
                    { !!page.localization.getText(1) &&
                        <Text style={{color: "var(--test-galaxytext)"}} variant="none" center small overflow="auto">{ page.localization.getText(1) }</Text> }
