    ...
    return (
        <NitroCardView uniqueKey="catalog-gift" className="nitro-catalog-gift" theme="primary-slim">
            ...
            <NitroCardContentView className="text-black">
                <FormGroup column>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ LocalizeText('catalog.gift_wrapping.receiver') }</Text>
                ...
                <Base className="form-check">
                    ...
                    <label style={{color: "var(--test-galaxytext)"}} className="form-check-label">{ LocalizeText('catalog.gift_wrapping.show_face.title') }</label>
                </Base>
                <Flex alignItems="center" gap={ 2 }>
                    ...
                    <Column gap={ 1 }>
                        <Flex gap={ 2 }>
                            ...
                            <Column gap={ 1 }>
                                <Text style={{color: "var(--test-galaxytext)"}} variant="none" fontWeight="bold">{ LocalizeText(boxName) }</Text>
                                <Flex style={{color: "var(--test-galaxytext)"}} alignItems="center" gap={ 1 }>
                        ...
                        <Flex alignItems="center" gap={ 2 }>
                            ...
                            <Text style={{color: "var(--test-galaxytext)"}} variant="none" fontWeight="bold">{ LocalizeText(ribbonName) }</Text>
                        </Flex>
                    </Column>
                </Flex>
                <Column gap={ 1 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none" fontWeight="bold">
                ...
                <Flex justifyContent="between" alignItems="center">
                    <Button variant="link" onClick={ close } style={{color: "var(--test-galaxytext)"}}>
                        { LocalizeText('cancel') }
                    </Button>
