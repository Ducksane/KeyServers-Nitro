...
export const SelectTopicView: FC<{}> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text style={{color: "var(--test-galaxytext)"}} variant="none" fontSize={ 4 }>{ LocalizeText('help.emergency.chat_report.subtitle') }</Text>
                <Text style={{color: "var(--test-galaxytext)"}} variant="none">{ LocalizeText('help.cfh.pick.topic') }</Text>
            </Column>
            ...
            <Flex gap={ 2 } justifyContent="between">
                <Button style={{color: "var(--test-galaxytext)"}} variant="none" onClick={ back }>
                    { LocalizeText('generic.back') }
                </Button>
                <Button style={{color: "var(--test-galaxytext)"}} variant="none" disabled={ (selectedTopic < 0) } onClick={ submitTopic }>
