...
export const HelpIndexView: FC<{}> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text style={{color: "var(--test-galaxytext)"}} variant="none" fontSize={ 3 }>{ LocalizeText('help.main.frame.title') }</Text>
                <Text style={{color: "var(--test-galaxytext)"}} variant="none" >{ LocalizeText('help.main.self.description') }</Text>
            </Column>
            <Column gap={ 1 }>
                ...
                <Button style={{color: "var(--test-galaxytext)"}} variant="none" onClick={ onRequestMySanctionStatusClick }>{ LocalizeText('help.main.my.sanction.status') }</Button>
            </Column>
        </>
    )
}
