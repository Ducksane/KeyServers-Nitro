        ...
        <Column>
            <Flex gap={ 1 }>
                ...
                <Column alignItems="center" size={ 4 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none" bold>{ LocalizeText('floor.plan.editor.enter.direction') }</Text>
                    <i className={ `icon icon-door-direction-${ visualizationSettings.entryPointDir } cursor-pointer` } onClick={ changeDoorDirection } />
                </Column>
                <Column size={ 3 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none" bold>{ LocalizeText('floor.editor.wall.height') }</Text>
            ...
            <Flex gap={ 1 }>
                <Column size={ 6 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none" bold>{ LocalizeText('floor.plan.editor.tile.height') }: { floorHeight }</Text>
                    <ReactSlider
                ...
                <Column size={ 6 }>
                    <Text style={{color: "var(--test-galaxytext)"}} variant="none" bold>{ LocalizeText('floor.plan.editor.room.options') }</Text>
