...
export const NavigatorRoomSettingsVipChatTabView: FC<NavigatorRoomSettingsTabViewProps> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.vip.caption') }</Text>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.vip.info') }</Text>
            </Column>
            <Grid overflow="auto">
                <Column size={ 6 } gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.chat_settings') }</Text>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.chat_settings.info') }</Text>
                    ...
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.chat_settings.hearing.distance') }</Text>
                ...
                <Column size={ 6 } gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.vip_settings') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.hide_walls') }</Text>
                    </Flex>
