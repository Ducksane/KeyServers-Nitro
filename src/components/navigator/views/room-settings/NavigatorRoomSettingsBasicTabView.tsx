    ...
    return (
        <>
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}}  className="col-3">{ LocalizeText('navigator.roomname') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} className="col-3">{ LocalizeText('navigator.roomsettings.desc') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} className="col-3">{ LocalizeText('navigator.category') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} className="col-3">{ LocalizeText('navigator.maxvisitors') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} className="col-3">{ LocalizeText('navigator.tradesettings') }</Text>
            ...
            <Flex alignItems="center" gap={ 1 }>
                ...
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.allow_walk_through') }</Text>
            </Flex>
