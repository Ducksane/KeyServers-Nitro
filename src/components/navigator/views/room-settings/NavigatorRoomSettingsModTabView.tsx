...
export const NavigatorRoomSettingsModTabView: FC<NavigatorRoomSettingsTabViewProps> = props =>
{
    ...
    return (
        <Grid overflow="auto">
            <Column size={ 6 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.moderation.banned.users') } ({ bannedUsers.length })</Text>
            ...
            <Column size={ 6 }>
                <Column gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.moderation.mute.header') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}}>{ LocalizeText('navigator.roomsettings.moderation.rights') }</Text>
                    </Flex>
                </Column>
                <Column gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.moderation.kick.header') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.moderation.all') }</Text>
                    </Flex>
                    <Flex alignItems="center" gap={ 1 }>
                ...
                <Column gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.moderation.ban.header') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
