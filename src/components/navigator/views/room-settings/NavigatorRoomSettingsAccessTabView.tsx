...
export const NavigatorRoomSettingsAccessTabView: FC<NavigatorRoomSettingsTabViewProps> = props =>
{
    ...
    return (
        <>
            <Column gap={ 1 }>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.roomaccess.caption') }</Text>
                <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.roomaccess.info') }</Text>
            </Column>
            <Column overflow="auto">
                <Column gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.doormode') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.doormode.open') }</Text>
                    </Flex>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.doormode.doorbell') }</Text>
                    </Flex>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.doormode.invisible') }</Text>
                    </Flex>
                    <Flex fullWidth gap={ 1 }>
                        ...
                        { !isTryingPassword && (roomData.lockState !== RoomDataParser.PASSWORD_STATE) &&
                            <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.doormode.password') }</Text> }
                        { (isTryingPassword || (roomData.lockState === RoomDataParser.PASSWORD_STATE)) &&
                            <Column gap={ 1 }>
                                <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.doormode.password') }</Text>
                ...
                <Column gap={ 1 }>
                    <Text variant="none" style={{color: "var(--test-galaxytext)"}}  bold>{ LocalizeText('navigator.roomsettings.pets') }</Text>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.allowpets') }</Text>
                    </Flex>
                    <Flex alignItems="center" gap={ 1 }>
                        ...
                        <Text variant="none" style={{color: "var(--test-galaxytext)"}} >{ LocalizeText('navigator.roomsettings.allowfoodconsume') }</Text>
                    </Flex>
                </Column>
            </Column>
        </>
