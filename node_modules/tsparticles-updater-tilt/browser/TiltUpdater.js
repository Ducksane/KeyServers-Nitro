...
export class TiltUpdater {
    ...
    init(particle) {
        ...
        if (tiltDirection === "random" /* TiltDirection.random */) {
            const index = Math.floor(Math.random() * 2);
            tiltDirection = index > 0 ? "counter-clockwise" /* TiltDirection.counterClockwise */ : "clockwise" /* TiltDirection.clockwise */;
        }
        switch (tiltDirection) {
            case "counter-clockwise" /* TiltDirection.counterClockwise */:
            case "counterClockwise":
                particle.tilt.status = 1 /* AnimationStatus.decreasing */;
                break;
            case "clockwise" /* TiltDirection.clockwise */:
                particle.tilt.status = 0 /* AnimationStatus.increasing */;
                break;
        }
