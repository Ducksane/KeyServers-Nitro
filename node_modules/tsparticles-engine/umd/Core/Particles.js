...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../Utils/NumberUtils", "./Utils/InteractionManager", "./Particle", "./Utils/Point", "./Utils/QuadTree", "./Utils/Rectangle", "../Utils/OptionsUtils"], factory);
    }
    ...
    class Particles {
        ...
        addSplitParticle(parent, splitParticlesOptions) {
            const splitOptions = parent.options.destroy.split, options = (0, OptionsUtils_1.loadParticlesOptions)(__classPrivateFieldGet(this, _Particles_engine, "f"), this.container, parent.options), factor = (0, NumberUtils_1.getValue)(splitOptions.factor);
            options.color.load({
                value: {
