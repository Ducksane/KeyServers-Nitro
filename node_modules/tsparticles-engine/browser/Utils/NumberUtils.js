...
export function getParticleDirectionAngle(direction, position, center) {
    if (typeof direction === "number") {
        ...
        switch (direction) {
            case "top" /* MoveDirection.top */:
                return -Math.PI / 2;
            case "top-right" /* MoveDirection.topRight */:
                return -Math.PI / 4;
            case "right" /* MoveDirection.right */:
                return 0;
            case "bottom-right" /* MoveDirection.bottomRight */:
                return Math.PI / 4;
            case "bottom" /* MoveDirection.bottom */:
                return Math.PI / 2;
            case "bottom-left" /* MoveDirection.bottomLeft */:
                return 3 * Math.PI / 4;
            case "left" /* MoveDirection.left */:
                return Math.PI;
            case "top-left" /* MoveDirection.topLeft */:
                return -3 * Math.PI / 4;
            case "inside" /* MoveDirection.inside */:
                return Math.atan2(center.y - position.y, center.x - position.x);
            case "outside" /* MoveDirection.outside */:
                return Math.atan2(position.y - center.y, position.x - center.x);
            case "none" /* MoveDirection.none */:
            default:
...
export function calcEasing(value, type) {
    switch (type) {
        case "ease-out-quad" /* EasingType.easeOutQuad */:
            return 1 - (1 - value) ** 2;
        case "ease-out-cubic" /* EasingType.easeOutCubic */:
            return 1 - (1 - value) ** 3;
        case "ease-out-quart" /* EasingType.easeOutQuart */:
            return 1 - (1 - value) ** 4;
        case "ease-out-quint" /* EasingType.easeOutQuint */:
            return 1 - (1 - value) ** 5;
        case "ease-out-expo" /* EasingType.easeOutExpo */:
            return value === 1 ? 1 : 1 - Math.pow(2, -10 * value);
        case "ease-out-sine" /* EasingType.easeOutSine */:
            return Math.sin(value * Math.PI / 2);
        case "ease-out-back" /* EasingType.easeOutBack */: {
            const c1 = 1.70158, c3 = c1 + 1;
            return 1 + c3 * Math.pow(value - 1, 3) + c1 * Math.pow(value - 1, 2);
        }
        case "ease-out-circ" /* EasingType.easeOutCirc */:
