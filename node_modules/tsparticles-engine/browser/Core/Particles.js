...
export class Particles {
    ...
    removeAt(index, quantity = 1, group, override) {
        ...
        for (let i = index; deleted < quantity && i < this.count; i++) {
            ...
            deleted++;
            __classPrivateFieldGet(this, _Particles_engine, "f").dispatchEvent("particleRemoved" /* EventType.particleRemoved */, {
    ...
    pushParticle(position, overrideOptions, group, initializer) {
        try {
            ...
            this.nextId++;
            __classPrivateFieldGet(this, _Particles_engine, "f").dispatchEvent("particleAdded" /* EventType.particleAdded */, {
                container: this.container,
                data: {
                    particle,
                },
