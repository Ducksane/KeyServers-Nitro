...
class Particle {
    constructor(engine, id, container, position, overrideOptions, group) {
        ...
        const pxRatio = container.retina.pixelRatio, mainOptions = container.actualOptions, particlesOptions = (0, OptionsUtils_1.loadParticlesOptions)(__classPrivateFieldGet(this, _Particle_engine, "f"), container, mainOptions.particles);
    ...
    split() {
        ...
        const rate = (0, NumberUtils_1.getValue)(splitOptions.rate), particlesSplitOptions = splitOptions.particles instanceof Array
            ? (0, Utils_1.itemFromArray)(splitOptions.particles)
