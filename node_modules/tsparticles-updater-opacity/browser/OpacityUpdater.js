...
function checkDestroy(particle, value, minValue, maxValue) {
    switch (particle.options.opacity.animation.destroy) {
        case "max" /* DestroyType.max */:
            if (value >= maxValue) {
                particle.destroy();
            }
            break;
        case "min" /* DestroyType.min */:
            if (value <= minValue) {
                particle.destroy();
            }
            break;
    ...
    switch (particle.opacity.status) {
        case 0 /* AnimationStatus.increasing */:
            if (particle.opacity.value >= maxValue) {
                particle.opacity.status = 1 /* AnimationStatus.decreasing */;
        ...
        case 1 /* AnimationStatus.decreasing */:
            if (particle.opacity.value <= minValue) {
                particle.opacity.status = 0 /* AnimationStatus.increasing */;
                if (!particle.opacity.loops) {
                    particle.opacity.loops = 0;
                }
                particle.opacity.loops++;
            ...
            switch (opacityAnimation.startValue) {
                ...
                case "random" /* StartValueType.random */:
                    ...
                    particle.opacity.status =
                        Math.random() >= 0.5 ? 0 /* AnimationStatus.increasing */ : 1 /* AnimationStatus.decreasing */;
                    break;
