    ...
    class Bubbler extends tsparticles_engine_1.ExternalInteractorBase {
        ...
        async interact() {
            ...
            if (hoverEnabled && (0, tsparticles_engine_1.isInArray)("bubble", hoverMode)) {
                ...
                (0, tsparticles_engine_1.divModeExecute)("bubble", divs, (selector, div) => this.singleSelectorHover(selector, div));
            }
        }
        isEnabled(particle) {
            var _a;
        ...
        hoverBubbleColor(particle, ratio, divBubble) {
            ...
            if (!particle.bubble.finalColor) {
                ...
                const bubbleColor = modeColor instanceof Array ? (0, tsparticles_engine_1.itemFromArray)(modeColor) : modeColor;
