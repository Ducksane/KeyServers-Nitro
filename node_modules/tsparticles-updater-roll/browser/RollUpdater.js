    ...
    init(particle) {
        ...
        if (rollOpt === null || rollOpt === void 0 ? void 0 : rollOpt.enable) {
            particle.roll = {
                ...
                horizontal: rollOpt.mode === "horizontal" /* RollMode.horizontal */ || rollOpt.mode === "both" /* RollMode.both */,
                vertical: rollOpt.mode === "vertical" /* RollMode.vertical */ || rollOpt.mode === "both" /* RollMode.both */,
            ...
            if (rollOpt.backColor) {
                ...
                const alterType = Math.random() >= 0.5 ? "darken" /* AlterType.darken */ : "enlighten" /* AlterType.enlighten */;
                particle.roll.alter = {
                    type: alterType,
                    value: getRangeValue(alterType === "darken" /* AlterType.darken */ ? rollOpt.darken.value : rollOpt.enlighten.value),
                };
            }
            else if (rollOpt.darken.enable) {
                particle.roll.alter = {
                    type: "darken" /* AlterType.darken */,
                    value: getRangeValue(rollOpt.darken.value),
                };
            }
            else if (rollOpt.enlighten.enable) {
                particle.roll.alter = {
                    type: "enlighten" /* AlterType.enlighten */,
